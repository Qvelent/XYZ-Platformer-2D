...
namespace Assets.PlayerOption.Scripts.Model.Data
{
    ...
    public class GameSettings : ScriptableObject
    {
        ...
        {
            _music = new FloatPersistentProperty(1, SoundEffect.Music.ToString());
            _sfx = new FloatPersistentProperty(1, SoundEffect.Sfx.ToString());
        }
